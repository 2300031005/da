...
<div className="self-stretch flex justify-center lg:justify-end items-end -mb-8 md:-mb-12 lg:-mb-16">
  <div className="relative w-full max-w-[420px] min-h-[320px] flex items-end justify-center overflow-visible">

    {/* Green Card */}
    <div className="absolute bottom-0 w-[300px] h-[320px] rounded-3xl bg-[#73d08f]" />

    {/* Man Image */}
    <img
      src={manImage}
      alt="DailyAlly service provider"
      className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[380px] object-contain z-10"
    />
